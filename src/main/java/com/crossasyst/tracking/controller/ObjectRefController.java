...
import com.crossasyst.tracking.service.ObjectRefService;
...
public class ObjectRefController {
    ...
    public ResponseEntity<ObjectRef> patchObjectRefById(@PathVariable Long objectRefID, @RequestBody @Valid ObjectRefPatch objectRefPatch) {

        objectRefService.patchObjectRefById(objectRefPatch, objectRefID);
